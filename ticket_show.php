...
$result = mysqli_query($conn, "SELECT c.movie, c.booking_date, c.show_time, c.seat, c.totalseat, c.price, c.payment_date, c.custemer_id, u.username, u.email, u.mobile, u.city, t.theater FROM customers c INNER JOIN user u ON c.uid = u.id INNER JOIN theater_show t ON c.show_time = t.show WHERE c.custemer_id = '$custemer_id'");

if (!$result || mysqli_num_rows($result) == 0) {
  echo "No booking found for the given customer ID.";
  exit();
}
      ...
      <div class="col-lg-6 mx-auto">
        <div class="card">
          <div class="card-header">
            ...
            <a href="generate_pdf.php" class="btn btn-primary" style="margin-top: 20px;">Download Summary as PDF</a>
          </div>
        </div>
      </div>
    </div>
